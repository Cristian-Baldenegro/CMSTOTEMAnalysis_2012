...
void data_SDdijet_jets_systematics_CMSTOTEM(bool jet = true, bool sys_up = true,  const Int_t nevt_max = -1){
...
//Float_t x[13] = { -0.05, -0.03, -0.01, 0.005, 0.01, 0.03, 0.05, 0.07, 0.09, 0.12, 0.15, 0.17, 0.2};
  ...
  histosTH1F["proton_right_t_signal_kint_kinxi"] = new TH1F("proton_right_t_signal_kint_kinxi", "-t" , 50, 0, 1.);
  histosTH1F["proton_right_t_signal_kint_kinxi_bin"] = new TH1F("proton_right_t_signal_kint_kinxi_bin", "-t" , 11 , tbins);
  histosTH1F["proton_right_t_signal_kint_kinxi_bin2"] = new TH1F("proton_right_t_signal_kint_kinxi_bin2", "-t" , 10, tbins_2);
  ...
  histosTH1F["proton_left_t_signal_kint_kinxi"] = new TH1F("proton_left_t_signal_kint_kinxi", "-t" , 50, 0, 1.);
  histosTH1F["proton_left_t_signal_kint_kinxi_bin"] = new TH1F("proton_left_t_signal_kint_kinxi_bin", "-t" , 11 , tbins);
  histosTH1F["proton_left_t_signal_kint_kinxi_bin2"] = new TH1F("proton_left_t_signal_kint_kinxi_bin2", "-t" , 10, tbins_2);
...
*/	 
      ...
      if(jet1_selected && jet2_selected && PF_eta_max && PF_eta_min){
         ...
         histosTH1F["leadingJet_pt"]->Fill( Jet1_pt, event_weight );
         histosTH1F["secondJet_pt"]->Fill( Jet2_pt, event_weight );
         histosTH1F["leadingJet_eta"]->Fill( Jet1_eta, event_weight );
         histosTH1F["secondJet_eta"]->Fill( Jet2_eta, event_weight );
         histosTH1F["massJets"]->Fill( mass_jets, event_weight );
         histosTH1F["log_x_minus_jj"]->Fill( log10(x_minus), event_weight );
         histosTH1F["log_x_minus_sel_jj"]->Fill( log10(x_minus_sel), event_weight );
         histosTH1F["log_x_plus_jj"]->Fill( log10(x_plus), event_weight );
         histosTH1F["log_x_plus_sel_jj"]->Fill( log10(x_plus_sel), event_weight );
      }
      ...
      if(jet1_selected && jet2_selected && good_proton_right && rp_track_accept_right){
         ...
         if (-xi_proton_right<=0.1 && t_region_right && xi_minus_Reco+xi_proton_right<0){
             ...
             histosTH1F["proton_right_t_signal_kint_kinxi_bin2"]->Fill( fabs(t_proton_right), event_weight );     
             histosTH1F["proton_right_t_signal_kint_kinxi_bin3"]->Fill( fabs(t_proton_right), event_weight );     
             histosTH1F["proton_right_t_signal_kint_kinxi_bin4"]->Fill( fabs(t_proton_right), event_weight );     
      ...
      if(jet1_selected && jet2_selected && good_proton_left && rp_track_accept_left){
         ...
         if (-xi_proton_left<=0.1 && t_region_left && xi_plus_Reco+xi_proton_left<0){
             ...
             histosTH1F["proton_left_t_signal_kint_kinxi_bin2"]->Fill( fabs(t_proton_left), event_weight );
